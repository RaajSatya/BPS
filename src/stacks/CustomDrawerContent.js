            ...
            <DrawerContentScrollView {...props}>
                <View style={{ margin: spacing.sm, rowGap: spacing.sm }}>
                    ...
                    {/* <DrawerItem {...props}
                        ...
                        icon={({ color }) => <MaterialCommunityIcons color={colors.background} name='account-outline' size={spacing.sm} />}
                        onPress={() => navigation.navigate('Profile')}
                    /> */}
                    <DrawerItem {...props}
                        label={'Logout'} labelStyle={{ color: colors.background, fontSize: fonts.bodyMedium.fontSize }}
                        icon={({ color }) => <MaterialCommunityIcons color={colors.background} name='logout' size={spacing.sm} />}
                        onPress={() => userLogout()}
                    />
                </View>
